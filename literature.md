...
- [OpenVPN](https://dial.uclouvain.be/memoire/ucl/en/object/thesis%3A2667/datastream/PDF_01/view)
- [Multipath Transport for Virtual Private Networks](https://www.usenix.org/system/files/conference/cset17/cset17-paper-lukaszewski.pdf)
- [VtrunkD](https://github.com/VrayoSystems/vtrunkd)
- [OpenWrt](https://github.com/openwrt/openwrt)
- [Multi-TCP wiki](https://github.com/multipath-tcp/mptcp_net-next/wiki/)
